...
export const PLUGINS: PluginMeta[] = [
  ...
  },
  {
    ...
    shortName: "rgpd",
    name: "RGPD",
    description: "Conformité RGPD, consentement, registre traitements",
    exportName: "rgpdPlugin",
    exportIsFactory: false,
    requires: ["@stormstack/auth"],
    dependencies: {},
    devDependencies: {},
  ...
  {
    id: "@stormstack/design",
    shortName: "design",
    name: "Design System",
    description: "Thème, composants UI, branding",
    exportName: "designPlugin",
    exportIsFactory: false,
    requires: [],
    dependencies: {},
    devDependencies: {},
  ...
  {
    id: "@stormstack/search",
    shortName: "search",
    name: "Search",
    description: "Recherche full-text, filtres, indexation",
  ...
  {
    id: "@stormstack/integrations",
    shortName: "integrations",
    name: "Integrations",
    description: "Webhooks, API publique, connecteurs tiers",
    exportName: "integrationsPlugin",
    exportIsFactory: false,
    requires: ["@stormstack/auth"],
    dependencies: {},
    devDependencies: {},
  ...
  },
  {
    ...
    shortName: "vault",
    name: "Vault",
    description: "Stockage chiffré, gestion secrets",
    exportName: "vaultPlugin",
    exportIsFactory: false,
    requires: ["@stormstack/auth"],
    dependencies: {},
    devDependencies: {},
  ...
  },
  {
    ...
    shortName: "dock",
    name: "Dock",
    description: "Dock macOS-style, raccourcis, widgets",
    exportName: "dockPlugin",
    exportIsFactory: false,
    requires: [],
    dependencies: {},
    devDependencies: {},
