...
const CATALOG_REGISTRY: Omit<CatalogEntry, "status">[] = [
  ...
  { id: "@stormstack/rgpd", shortName: "rgpd", name: "RGPD", description: "Conformité RGPD, consentement et registre des traitements", tags: ["rgpd", "gdpr", "privacy", "compliance"], pricing: "free", requires: ["@stormstack/auth"], envVars: {}, version: PACKAGE_VERSION, category: "security" },
  { id: "@stormstack/design", shortName: "design", name: "Design System", description: "Thème, composants UI, branding et tokens", tags: ["design", "ui", "theme", "branding"], pricing: "free", requires: [], envVars: {}, version: PACKAGE_VERSION, category: "ui" },
  { id: "@stormstack/search", shortName: "search", name: "Search", description: "Recherche full-text, filtres avancés et indexation", tags: ["search", "fulltext", "indexing"], pricing: "free", requires: ["@stormstack/auth"], envVars: {}, version: PACKAGE_VERSION, category: "content" },
  { id: "@stormstack/integrations", shortName: "integrations", name: "Integrations", description: "Webhooks, API publique et connecteurs tiers", tags: ["integrations", "webhooks", "api"], pricing: "free", requires: ["@stormstack/auth"], envVars: {}, version: PACKAGE_VERSION, category: "devops" },
  { id: "@stormstack/vault", shortName: "vault", name: "Vault", description: "Stockage chiffré, gestion de secrets et clés API", tags: ["vault", "encryption", "secrets"], pricing: "free", requires: ["@stormstack/auth"], envVars: {}, version: PACKAGE_VERSION, category: "security" },
  { id: "@stormstack/dock", shortName: "dock", name: "Dock", description: "Dock macOS-style, raccourcis et widgets flottants", tags: ["dock", "ui", "widgets", "shortcuts"], pricing: "free", requires: [], envVars: {}, version: PACKAGE_VERSION, category: "ui" },
];
